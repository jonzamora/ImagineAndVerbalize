...
def inference(args, seed, model=None):
    ...
    args.input_format = old_args.input_format
...
def main():
    ...
    # auxilary loss
    parser.add_argument("--corrupt_type", type=str, default=None)
    parser.add_argument('--mask_ratio', default=0, type=float)

    # mask ER prediction
    parser.add_argument('--mask_pred_alpha', default=0, type=float)
    parser.add_argument('--graph_mask_ratio', default=0, type=float)

    # graph denoising
    parser.add_argument('--sample_ratio', default=0, type=float)
    parser.add_argument("--sample_strategy", type=str, default=None)

    # graph reconstruction
    parser.add_argument('--rec_alpha', default=0, type=float)
    parser.add_argument('--num_rec_layer', default=6, type=int)
    ...
    parser.add_argument('--pretrain_epoch', type=float, default=0)
